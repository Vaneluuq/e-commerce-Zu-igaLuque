    ...
    <>
      <div className={cx("m-3", "card")}>
        <div
          className={cx(
            "imagenHover",
            "relative h-3/4 flex justify-center items-center overflow-hidden"
          )}
        >
          <div
            className={cx("absolute top-2 right-0 p-1", "price")}
          >{`${currencyFormat(data.price)}`}</div>
          ...
          <div className={cx("absolute", "color")}>
            ...
            >
              <div
                className={cx("flex justify-center flex-col", "containerCart")}
              >
                <span>Numero de unidades</span>
                <div className="flex justify-center py-2">
                  <button
                    className={cx(
                      "border-2 border-current w-10 rounded-md bg-slate-300 border-0",
                      "pressButton"
                    )}
                ...
                <button
                  onClick={() => addToShopping(data)}
                  className={cx("text-white py-1", "buttonAdd")}
                >
                  Agregar al carrito
                </button>
              </div>
